...
CREATE PROCEDURE SP_Loguear 
    ...
    @PASS VARCHAR(50)
AS
    SELECT U.ID, IDPERFIL, P.APELLIDO, P.NOMBRE, P.DNI FROM USUARIO U INNER JOIN PERSONA P ON P.IDUSUARIO = U.ID WHERE P.MAIL = @MAIL AND U.PASS = @PASS
GO

CREATE PROCEDURE SP_BuscarUsuarioXMail 
    @MAIL VARCHAR(50)
AS
    SELECT U.ID, IDPERFIL, P.APELLIDO, P.NOMBRE, P.DNI, P.MAIL FROM USUARIO U INNER JOIN PERSONA P ON P.IDUSUARIO = U.ID WHERE P.MAIL = @MAIL
GO
