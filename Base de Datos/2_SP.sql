...
SELECT P.ID, P.APELLIDO, P.NOMBRE, P.FECHA_NACIMIENTO, P.DNI, P.MAIL, P.IDUSUARIO, P.ACTIVO, U.PASS, PER.ID IDPERFIL, PER.NOMBRE NOMBRE_PERFIL FROM PERSONA P INNER JOIN USUARIO U ON U.ID = P.IDUSUARIO INNER JOIN PERFIL PER ON PER.ID = U.IDPERFIL WHERE PER.NOMBRE NOT IN ('Médico')
GO

CREATE PROCEDURE SP_ListarPersonalxId 
    @ID INT
AS
SELECT P.ID, P.APELLIDO, P.NOMBRE, P.FECHA_NACIMIENTO, P.DNI, P.MAIL, P.IDUSUARIO, P.ACTIVO, U.PASS, PER.ID IDPERFIL, PER.NOMBRE NOMBRE_PERFIL FROM PERSONA P INNER JOIN USUARIO U ON U.ID = P.IDUSUARIO INNER JOIN PERFIL PER ON PER.ID = U.IDPERFIL WHERE PER.NOMBRE NOT IN ('Médico') AND P.ID = @ID 
GO
