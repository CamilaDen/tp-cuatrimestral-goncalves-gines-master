    ...
    <div class="container">
        ...
        <asp:UpdatePanel runat="server">
            <ContentTemplate>
                    ...
                    <div class="col-3">
                        <div class="mb-3">
                            ...
                            <asp:DropDownList runat="server" ID="ddlCampo" CssClass="form-control" >
                                ...
                                <asp:ListItem Text="Sigla" />
                                <asp:ListItem Text="CUIT" />
                                <asp:ListItem Text="Teléfono" />
                                <asp:ListItem Text="Dirección" />
                ...
                <% }%>
                <asp:GridView ID="dgvCoberturas" runat="server" CssClass="table align-middle table-hover table-sm" AutoGenerateColumns="false" DataKeyNames="Id" EmptyDataText="No hay resultados!" OnSelectedIndexChanged="dgvCoberturas_SelectedIndexChanged">
                    <Columns>
