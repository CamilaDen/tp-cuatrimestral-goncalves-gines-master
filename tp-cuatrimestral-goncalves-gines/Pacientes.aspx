    ...
    <div class="container">
        ...
        <asp:UpdatePanel runat="server">
            <ContentTemplate>
                    ...
                    <div class="col-3">
                        <div class="mb-3">
                            ...
                            <asp:DropDownList runat="server" ID="ddlCampo" CssClass="form-control" AutoPostBack="true" OnSelectedIndexChanged="ddlCampo_SelectedIndexChanged">
                                ...
                                <asp:ListItem Text="Credencial" />
                                <asp:ListItem Text="Peso" />
                                <asp:ListItem Text="Altura" />
                            </asp:DropDownList>
                        </div>
                    </div>
                    <div class="col-3">
                ...
                <% }%>
                <asp:GridView ID="dgvPacientes" runat="server" CssClass="table align-middle table-hover table-sm" EmptyDataText="No hay resultados!" AutoGenerateColumns="false" DataKeyNames="Id" OnSelectedIndexChanged="dgvPacientes_SelectedIndexChanged">
                    <Columns>
